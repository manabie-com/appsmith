...
const SvgMedicationLiquidTwoTone = (props) => (
  <svg
  ...
  >
    ...
    <g opacity={0.3}>
      <defs>
        <path
          id="medication_liquid_two_tone__svg__a"
          d="M4 8h10v11H4z"
          opacity={0.3}
        />
      </defs>
      <use xlinkHref="#medication_liquid_two_tone__svg__a" overflow="visible" />
      <clipPath id="medication_liquid_two_tone__svg__b">
        <use
          xlinkHref="#medication_liquid_two_tone__svg__a"
          overflow="visible"
        />
      </clipPath>
      <path
        d="M4 19h10V8H4v11zm1-7h2.5V9.5h3V12H13v3h-2.5v2.5h-3V15H5v-3z"
        clipPath="url(#medication_liquid_two_tone__svg__b)"
      />
    </g>
...
export default SvgMedicationLiquidTwoTone;
